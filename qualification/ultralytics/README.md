...
# After iAutolabeling
$ python train.py --model_name /home/wish/pro/ICME2024/src/iAutolabeling_conf_0.2/runs/facial/train5/weights/best.pt --yaml_path facial_v4.yaml --n_epoch 300 --n_patience 100 --bs 48 --imgsz 640 --n_worker $(nproc) --save_path ./run/facial
```
