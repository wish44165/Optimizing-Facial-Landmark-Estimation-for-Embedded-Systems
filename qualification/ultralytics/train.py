...
def parse_opt(known=False):
    ...
    parser.add_argument('--model_name', type=str, default='/home/wish/pro/ICME2024/src/iAutolabeling_conf_0.2/runs/facial/train5/weights/best.pt', help='model name')
    parser.add_argument('--yaml_path', type=str, default='./facial_v4.yaml', help='The yaml path')
