...
def parse_opt(known=False):
    ...
    parser.add_argument('--model_name', type=str, default='yolov8n-pose.pt', help='model name')
...
if __name__ == '__main__':
    # Train the model
    model.train(data=opt.yaml_path, epochs=opt.n_epoch, patience=opt.n_patience, batch=opt.bs, imgsz=opt.imgsz, device=0, workers=opt.n_worker, project=opt.save_path, pose=opt.pose)