...
def parse_opt(known=False):
    ...
    parser.add_argument('--weight', type=str, default='./runs/facial/train2/weights/best.pt', help='trained model')
    ...
    parser.add_argument('--conf', type=float, default=0.65, help='')
...
results = model(opt.predict_folder, save=True, save_txt=True, project=opt.save_path, conf=opt.conf)